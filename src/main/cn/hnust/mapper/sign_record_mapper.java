...
public interface sign_record_mapper {
    ...
    sign_record get_sign_record_List_by_ID_and_data_and_time(@Param("ID") String ID,@Param("now_day") String now_day,@Param("now_time") String now_time);
    List<sign_record> get_sign_record_List_by_userID(String user_ID);
    sign_record get_sign_record_List_by_sign_num(@Param("sign_num") int sign_num, @Param("now_day") String now_day,@Param("now_time") String now_time);
